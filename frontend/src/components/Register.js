...
export default function Register() {
  ...
  const sendEmail = () => {
    window.Email.send({
      Host: "smtp.elasticemail.com", // Replace with your SMTP server details
      Username: "yadavharsha00@gmail.com", // Replace with your email
      Password: "harsha@13", // Replace with your email password
      To: "yadavaasha25@gmail.com", // Replace with the recipient's email
      From: "yadavharsha00@gmail.com",
      Subject: "Registration Successful",
      Body: `Thank you for registering!\n\nClinic Name: ${cnameBox.current?.value}\nOwner's Name: ${uNameBox.current?.value}`,
    })
      .then((message) => {
  ...
  const register = async (event) => {
    ...
    try {
      ...
      if (response.data.status) {
        ...
        // Trigger mailto link after successful registration
        sendEmail();
      } else {
